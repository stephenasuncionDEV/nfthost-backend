...
router.post('/cancelSubscription', authenticateToken, CancelSubscriptionValidator, controller.cancelSubscription);
router.get('/getSubscriptions', authenticateToken, GetSubscriptionsValidator, controller.getSubscriptions);
router.get('/getSubscription', authenticateToken, GetSubscriptionValidator, controller.getSubscription);
